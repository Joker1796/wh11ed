...
const faqIndexStale = await run('factionFaq search index (--check)', './gen-faction-faq-search-index.mjs', ['--check'])
...
if (faqIndexStale) console.log('⚠ src/data/factionFaqSearchIndex.js is stale — run `npm run faq:index`.')
