...
This unit's melee attacks that target a Psyker unit have the [PRECISION] ability. In addition, when this unit declares a charge, if an enemy Psyker unit is within 12" of this unit, you can re-roll that Charge roll; if you do, this unit must end that charge move engaged with one or more of those enemy Psyker units.
...
If this unit has the Infantry keyword: At the end of your Command phase, if this unit is within range of an objective marker you control, that objective marker remains under your control until your opponent's Level of Control over that objective marker is greater than yours at the end of a phase. In addition, if the mission you are playing features Actions, this unit is eligible to start to perform an Action in a turn in which it Advanced.
  ...
  detachments: [
    // ───────────────────────── CODEX BASE DETACHMENTS ─────────────────────────
    {
      ...
      rule: {
        ...
        body: `You can re-roll Advance and Charge rolls made for Adeptus Astartes units from your army.${chapterLock}`,
      },
      stratagems: [
        {
          name: 'Devout Push',
      ...
      enhancements: [
        {
          ...
          body: `Chaplain or Judiciar model only. Improve the Armour Penetration characteristic of melee weapons equipped by models in the bearer's unit by 1.`,
        },
        {
          ...
          body: `Chaplain or Judiciar model only. Each time a model in the bearer's unit makes a melee attack, you can re-roll the Hit roll.`,
        },
        {
          ...
          body: `Adeptus Astartes Infantry model only. Add 1 to Advance rolls made for the bearer's unit. If the mission pack you are playing features Actions, the bearer's unit is eligible to start to perform an Action in a turn in which it Advanced.`,
        },
        {
...

    {
      ...
      rule: {
        ...
        body: `▪ Each time an attack targets an Ancient unit from your army, if that unit is within range of one or more objective markers and the Strength characteristic of that attack is greater than the Toughness characteristic of that unit, subtract 1 from the Wound roll.
▪ Each time a friendly Crusader Squad unit makes a surge move, instead of selecting a surge target, you can select the closest objective to that unit. When that unit makes that surge move, each model in that unit must end that surge move as close as possible to that objective instead.${chapterLock}`,
      },
      stratagems: [
        {
      ...
      enhancements: [
        ...
        },
        {
          ...
          body: `Ancient model only. Each time an enemy unit selects the bearer's unit as a target of a charge, subtract 2 from the Charge roll (this is not cumulative with any other negative modifiers to that Charge roll).`,
        },
        {
          ...
          body: `Adeptus Astartes model only. Models in the bearer's unit have the Deep Strike ability.`,
        },
        {
          ...
          body: `Crusade Ancient model only. While the bearer is leading a unit, each time you roll one D6 for the bearer's Vengeful Exhortation ability, add 1 to the result.`,
        },
      ],
    },

    {
      ...
      rule: {
        ...
        body: `▪ Each time an Adeptus Astartes unit from your army declares a charge, if it disembarked from a Transport this turn, after selecting the targets of that charge, select one of those targets; that enemy unit must take a Battle-shock test.
▪ Each time a model in an Adeptus Astartes unit from your army makes a melee attack, if it disembarked from a Transport this turn, add 1 to the Hit roll.${chapterLock}`,
      },
      stratagems: [
        {
      ...
      enhancements: [
        {
          ...
          body: `Adeptus Astartes model only. Add 2 to the Strength characteristic of melee weapons equipped by the bearer. Each time a melee attack made by the bearer is allocated to an enemy model, if the bearer disembarked from a Transport this turn, add 1 to the Damage characteristic of that attack.`,
        },
        {
          ...
          body: `Adeptus Astartes model only. Each time the bearer's unit declares a charge, if an enemy unit takes a Battle-shock test as a result of the Shock and Awe Detachment rule, subtract 1 from that Battle-shock test.`,
        },
        {
          ...
          body: `Adeptus Astartes model only. At the start of your Shooting phase, select one enemy unit within 12" of and visible to the bearer. Until the end of the phase, models in that unit cannot have the Benefit of Cover.`,
        },
        {
          ...
          body: `Adeptus Astartes model only. In the Declare Battle Formations step, if the bearer starts the battle embarked within a Dedicated Transport, that Dedicated Transport has the Scouts 9" ability.`,
        },
      ],
    },
    ...
    // ───────────────────────── FACTION-PACK DETACHMENTS ─────────────────────────
    {
      ...
      rule: {
        ...
        body: `Friendly Sword Brethren Squad units have +1 Objective Control.${chapterLock}`,
      },
      stratagems: [
        {
      ...
      enhancements: [
        {
          ...
          body: `Sword Brethren Squad unit only. This unit has +1 to Charge rolls.`,
        },
        {
          ...
          body: `Sword Brethren Squad unit only. This unit has Fights First.`,
        },
      ],
    },

    {
      ...
      rule: {
        ...
        body: `▪ When a friendly Emperor's Champion unit is selected to fight, that model's melee attacks can re-roll one Hit roll and re-roll one Wound roll.
▪ Enhancements selected from this detachment do not count towards the total number of enhancements in your army.${chapterLock}`,
      },
      stratagems: [],
      enhancements: [
        {
          ...
          body: `Emperor's Champion model only. At the start of the first battle round, you can select up to three of the following abilities. This model has those abilities until the end of the battle:
▪ **Instrument of the God-Emperor (Once per battle, per army):** In the Fight phase, when this unit is selected to fight, if this unit is engaged with an enemy Character unit, you can use this ability. If you do, this model's melee attacks have the [DEVASTATING WOUNDS] ability.
...
▪ **Omen of Sacred Intervention:** When you target this unit with the Heroic Intervention Stratagem, that use is 1CP.
▪ **Harbinger of Judgement:** When an enemy unit (excluding Monster or Vehicle units) engaged with this model is selected to make a Fall Back move, roll one D6: on a 2+, that enemy unit suffers D6 mortal wounds.`,
        },
      ],
    },

    {
      ...
      rule: {
        ...
        body: `Friendly Chaplain units have a 5+ invulnerable save against ranged attacks.${chapterLock}`,
      },
      stratagems: [
        {
      ...
      enhancements: [
        {
          ...
          body: `Execrator model only. When this unit is selected to fight, this model's melee attacks have the [CLEAVE 1] ability, or the [PRECISION] ability.`,
        },
        {
          ...
          body: `Chaplain model only. This model's melee attacks have the [DEVASTATING WOUNDS] ability.`,
        },
      ],
    },
  ],
