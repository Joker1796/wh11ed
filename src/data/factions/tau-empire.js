      ...
      stratagems: [
        {
          ...
          target: "One [core:Stealth], Ghostkeel or Commander Shadowsun unit from your army.",
      ...
      enhancements: [
        {
          ...
          body: "KROOT SHAPER model only. In the [gloss:declare-battle-formations:Declare Battle Formations] step, you can select up to three [gloss:friendly:friendly] KROOT CARNIVORES/FARSTALKERS units. Those units have [core:Deep Strike].",
        },
        {
          name: "Admired Leader",
          points: 20,
