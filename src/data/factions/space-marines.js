  ...
  detachments: [
    // ───────────────────────── CODEX BASE DETACHMENTS ─────────────────────────
    {
      ...
      rule: {
        ...
        body: `At the start of your Command phase, you can select one of the Combat Doctrines listed below. Until the start of your next Command phase, that Combat Doctrine is active and its effects apply to all Adeptus Astartes units from your army. You can only select each Combat Doctrine once per battle.
...
This unit is eligible to declare a charge in a turn in which it Advanced.`,
...

    {
      ...
      rule: {
        ...
        body: `Ranged weapons equipped by Adeptus Astartes models from your army have the [HEAVY] ability. If such a weapon already has this ability, each time an attack is made with that weapon, if the attacking model's unit Remained Stationary this turn, add 1 to the Wound roll.`,
      },
      stratagems: [
      ...
      enhancements: [
        {
          ...
          body: `Adeptus Astartes model only. While the bearer is leading a unit, ranged weapons equipped by models in that unit have the [IGNORES COVER] ability.`,
        },
        {
...

    {
      ...
      rule: {
        ...
        body: `Once per phase for each Adeptus Astartes unit in your army, you can re-roll one Hit roll, one Wound roll or one Damage roll made for a model in that unit.`,
      },
      stratagems: [
        {
      ...
      enhancements: [
        {
          ...
          body: `Techmarine model only. Once per battle round, when a saving throw is failed for a friendly Adeptus Astartes Vehicle model within 6" of the bearer, you can change the Damage characteristic of that attack to 0.`,
        },
        {
          ...
          body: `Adeptus Astartes model only. In your Command phase, select one Adeptus Astartes Vehicle model within 6" of the bearer. Until the start of your next Command phase, that Vehicle is eligible to shoot even if it Fell Back or Advanced this turn.`,
        },
        {
          ...
          // Faction-Pack Rules Update: no longer an Aura; reworded to a Command-phase selection.
          body: `Techmarine model only. In your Command phase, select one Adeptus Astartes Vehicle model within 6" of the bearer. Until the start of your next Command phase, weapons equipped by that Vehicle model have the [LETHAL HITS] ability.`,
        },
        {
...

    {
      ...
      enhancements: [
        ...
        },
        {
          ...
          body: `Tacticus model only. While the bearer is leading a unit, models in that unit can ignore any or all modifiers to their characteristics and/or to any roll or test made for them (excluding modifiers to saving throws).`,
        },
        {
      ...
      enhancements: [
        {
          ...
          body: `Adeptus Astartes model only. While the bearer is leading a unit, that unit is eligible to shoot in a turn in which it Fell Back.`,
        },
        {
      ...
      enhancements: [
        {
          ...
          body: `Phobos model only. In your Shooting phase, after the bearer's unit has shot, if that unit is not within Engagement Range of one or more enemy units, it can make a Normal move of up to 6". If it does, until the end of the turn, that unit is not eligible to declare a charge. This cannot allow the bearer's unit to move more than once in your Shooting phase.`,
        },
        {
        ...
        },
        {
          ...
          body: `Phobos model only. Once per turn, when your opponent targets a unit from their army within 12" of this model with a Stratagem, you can use this ability. If you do, increase the CP cost of that use of that Stratagem by 1CP.`,
        },
        {
...

    {
      ...
      rule: {
        ...
        body: `Once per battle, in your Command phase, you can use this ability. If you do, until the start of your next Command phase, each time a model from your army with the Oath of Moment ability makes an attack that targets your Oath of Moment target, you can re-roll the Wound roll as well.`,
      },
      stratagems: [
