...
### Keywords
Tzaangors units from your army have the Battleline [gloss:keywords:keyword], and while such a unit is not Battle-shocked, add 1 to the Objective Control characteristic of Tzaangor models in that unit.
...
This detachment has the MUTANT tag and cannot be taken with another MUTANT detachment.`,
      ...
      enhancements: [
        ...
        },
        {
          ...
          body: `Sorcerer or Infernal Master model only. The bearer has the [core:Scouts 6"] ability.
