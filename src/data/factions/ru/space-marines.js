      ...
      stratagems: [
        {
          ...
          effect: 'До конца хода ваш юнит может игнорировать любые или все модификаторы своих характеристик и/или любого броска или теста, сделанного для него (исключая модификаторы спас-бросков).',
          restrictions: '',
        },
        armourOfContempt,
        {
      ...
      enhancements: [
        {
          ...
          body: `Только модель Techmarine. Один раз за раунд боя, когда для дружественной модели Adeptus Astartes Vehicle в пределах 6" от носителя проваливается спас-бросок, вы можете изменить характеристику урона той атаки на 0.`,
        },
        {
    ...
    // ─────────────── Firestorm Assault Force ───────────────
    {
      ...
      enhancements: [
        ...
        },
        {
          ...
          body: `Только модель Tacticus. Пока носитель возглавляет юнит, модели того юнита могут игнорировать любые или все модификаторы своих характеристик и/или любого броска или теста, сделанного для них (исключая модификаторы спас-бросков).`,
        },
        {
    ...
    // ─────────────── Stormlance Task Force ───────────────
    {
      ...
      enhancements: [
        ...
        },
        {
          ...
          body: `Только модель Adeptus Astartes Mounted. Улучшите характеристики Силы и бронепробития (AP) оружия ближнего боя носителя на 1. Каждый раз, когда носитель завершает манёвр нападения, до конца хода вместо этого улучшите характеристики Силы и бронепробития (AP) оружия ближнего боя носителя на 2.`,
        },
        {
