      ...
      stratagems: [
        {
          ...
          effect: 'Атаки вашего юнита в ближнем бою получают +1 к характеристике Силы.',
          restrictions: '',
        },
        {
      ...
      enhancements: [
        {
          ...
          body: `Только модель Adeptus Astartes Fly Infantry. Когда этот юнит завершает манёвр вторжения, выберите до одного вражеского юнита в пределах 9" от этого юнита. Тот вражеский юнит проходит тест на боевой шок с -1 к этому тесту на боевой шок.`,
        },
        {
