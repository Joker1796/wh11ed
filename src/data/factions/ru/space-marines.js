...
Этот юнит может объявлять нападение в ходу, в котором он продвигался.`,
      ...
      stratagems: [
        ...
        },
        {
          ...
          restrictions: 'Вы не можете выбрать юнит, находящийся в радиусе связывания с одним или более вражескими юнитами.',
        },
      ],
      enhancements: [
        {
    ...
    // ─────────────── Firestorm Assault Force ───────────────
    {
      ...
      stratagems: [
        ...
        },
        {
          ...
          restrictions: 'Вы не можете выбрать юнит Infantry, находящийся в радиусе связывания с одним или более вражескими юнитами, который в обычной ситуации не может погрузиться в тот Transport или который высадился из Transport в этом ходу.',
        },
        {
      ...
      enhancements: [
        {
          ...
          body: `Только модель Phobos. В вашей фазе стрельбы, после того как юнит носителя отстрелялся, если тот юнит не в радиусе связывания с одним или более вражескими юнитами, он может совершить обычный манёвр до 6". Если он это делает, до конца хода тот юнит не может объявлять нападение. Это не может позволить юниту носителя двигаться более одного раза в вашу фазу стрельбы.`,
        },
        {
