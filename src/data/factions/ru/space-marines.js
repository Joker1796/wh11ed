...
▪ Если у юнита Adeptus Astartes на листе данных есть второе фракционное ключевое слово, это ключевое слово — название ордена этого юнита. Например, у Marneus Calgar есть ключевые слова Adeptus Astartes и Ultramarines, и он из ордена Ультрамаринов.
