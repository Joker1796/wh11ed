...
export default {
  armyRule: {
    ...
    body: `Если фракция вашей армии — Adeptus Astartes, в начале вашей фазы командования выберите один юнит из армии оппонента. До начала вашей следующей фазы командования этот вражеский юнит — ваша цель Oath of Moment. Каждый раз, когда модель с этой способностью совершает атаку по вашей цели Oath of Moment:
▪ Вы можете перебросить бросок на попадание.
▪ Если вы используете детачмент Codex: Space Marines и в вашей армии нет ни одного юнита с ключевым словом Blood Angels, Dark Angels, Deathwatch или Space Wolves, добавьте также 1 к броску на ранение.
...
Этот юнит может объявлять нападение в ходу, в котором он продвигался.`,
      ...
      stratagems: [
        ...
        },
        {
          ...
          target: 'Один юнит Adeptus Astartes вашей армии.',
          effect: 'Выберите Devastator Doctrine, Tactical Doctrine или Assault Doctrine. До начала вашей следующей фазы командования эта Combat Doctrine активна для этого юнита вместо любой другой Combat Doctrine, активной для вашей армии, даже если вы уже выбирали эту Combat Doctrine в этой битве.',
          restrictions: '',
        },
        {
    ...
    // ─────────────── Anvil Siege Force ───────────────
    {
      rule: {
        ...
        body: `Оружие дальнего боя моделей Adeptus Astartes вашей армии имеет способность [HEAVY]. Если такое оружие уже имеет эту способность, каждый раз, когда им совершается атака, если юнит атакующей модели оставался неподвижным в этом ходу, добавьте 1 к броску на ранение.`,
      },
      stratagems: [
        armourOfContempt,
        {
          ...
          when: 'Ваша фаза стрельбы.',
          target: 'Один юнит Adeptus Astartes вашей армии, который ещё не был выбран для стрельбы в этой фазе.',
          effect: 'До конца фазы каждый раз, когда модель вашего юнита совершает атаку дальнего боя по юниту Monster или Vehicle, вы можете перебросить бросок на ранение.',
          restrictions: '',
        },
        {
        ...
        },
        {
          ...
          when: 'Ваша фаза стрельбы.',
          target: 'Один юнит Adeptus Astartes вашей армии, который ещё не был выбран для стрельбы в этой фазе.',
          effect: 'До конца фазы оружие дальнего боя моделей вашего юнита имеет способность [SUSTAINED HITS 1]. Если ваш юнит оставался неподвижным в этом ходу, то до конца фазы каждый раз, когда модель вашего юнита совершает атаку дальнего боя, критическое попадание засчитывается на успешном немодифицированном броске на попадание 5+.',
          restrictions: '',
        },
        {
    ...
    // ─────────────── Ironstorm Spearhead ───────────────
    {
      rule: {
        ...
        body: `Один раз за фазу для каждого юнита Adeptus Astartes в вашей армии вы можете перебросить один бросок на попадание, один бросок на ранение или один бросок урона, сделанный для модели того юнита.`,
      },
      stratagems: [
        {
        ...
        armourOfContempt,
        {
          ...
          effect: 'До конца фазы каждый раз, когда модель вашего юнита совершает атаку по юниту, находящемуся ниже своей стартовой численности, та атака имеет способность [SUSTAINED HITS 1], и при совершении такой атаки, если атакующая модель — Vehicle, критическое попадание засчитывается на успешном немодифицированном броске на попадание 5+.',
          restrictions: '',
        },
        {
        ...
        },
        {
          ...
          effect: 'До начала вашей следующей фазы командования улучшите характеристики движения, стойкости, лидерства и контроля над целью вашей модели на 1, и каждый раз, когда ваша модель совершает атаку, добавьте 1 к броску на попадание.',
          restrictions: '',
        },
        {
      ...
      enhancements: [
        ...
        },
        {
          ...
          body: `Только модель Adeptus Astartes. В вашей фазе командования выберите одну модель Adeptus Astartes Vehicle в пределах 6" от носителя. До начала вашей следующей фазы командования тот Vehicle может стрелять, даже если он отступил или продвигался в этом ходу.`,
        },
        {
          ...
          body: `Только модель Techmarine. В вашей фазе командования выберите одну модель Adeptus Astartes Vehicle в пределах 6" от носителя. До начала вашей следующей фазы командования оружие той модели Vehicle имеет способность [LETHAL HITS].`,
        },
        {
    ...
    // ─────────────── Firestorm Assault Force ───────────────
    {
      ...
      stratagems: [
        ...
        },
        {
          ...
          effect: 'До конца фазы каждый раз, когда модель вашего юнита совершает атаку дальнего боя по ближайшей допустимой цели в пределах 12", добавьте 1 к броску на попадание. Если в результате любой из этих атак уничтожены одна или более вражеских моделей, выберите одну из этих уничтоженных моделей; юнит той уничтоженной модели должен пройти тест на боевой шок.',
          restrictions: '',
        },
        {
    ...
    // ─────────────── 1st Company Task Force ───────────────
    {
      ...
      stratagems: [
        armourOfContempt,
        {
          ...
          effect: 'До конца фазы каждый раз, когда модель вашего юнита совершает атаку, добавьте 1 к броску на попадание. Если ваш юнит ниже половинной численности, добавьте также 1 к броску на ранение.',
          restrictions: '',
        },
        {
...
Юниты Adeptus Astartes Vehicle вашей армии (исключая Fortifications, Drop Pods, Walkers и юниты, которые могут Fly) имеют ключевое слово Tank Ace. На шаге Muster Armies вы можете выбрать до трёх юнитов Tank Ace вашей армии, чтобы они получили ключевое слово Character.`,
      ...
      enhancements: [
        ...
        },
        {
          ...
          body: `Только модель Adeptus Astartes Vehicle. Носитель имеет неуязвимый спасбросок 5+ и в конце вашей фазы командования восстанавливает 1 потерянную рану.`,
        },
      ],
    },
