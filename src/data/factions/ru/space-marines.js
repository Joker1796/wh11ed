...
▪ Divination Discipline: Атаки этого юнита могут перебрасывать броски на попадание 1 и броски на ранение 1.
...
▪ Telepathy Discipline: Атаки этого юнита могут игнорировать модификаторы меткости в дальнем бою, меткости в ближнем бою и бросков на попадание.`,
      },
      enhancements: [
        {
...
▪ Transhuman Perception: В вашей фазе стрельбы этот юнит может выбрать один видимый вражеский юнит в пределах 12". Тот вражеский юнит обнаружен. Пока юнит обнаружен, он имеет +3" к дальности обнаружения.`,
      ...
      enhancements: [
        ...
        },
        {
          ...
          body: `Только юнит Infantry Phobos. Атаки этого юнита по скрытому юниту имеют +1 к броскам на попадание.`,
        },
      ],
    },
...
Юниты Adeptus Astartes Transport вашей армии (исключая Fly) с характеристикой ран 14+ имеют ключевое слово Heavy Transport.`,
      ...
      stratagems: [
        ...
        },
        {
          ...
          when: 'Ваша фаза стрельбы.',
          target: 'Один юнит Adeptus Astartes вашей армии, который ещё не был выбран для стрельбы в этой фазе.',
          effect: 'До конца фазы каждый раз, когда модель вашего юнита совершает атаку, добавьте 1 к броску на попадание (если ваш юнит высадился из Heavy Transport в этом ходу, добавьте также 1 к броску на ранение).',
          restrictions: '',
        },
      ],
      enhancements: [
        ...
        },
        {
          ...
          body: `Только модель Adeptus Astartes. Если вы контролируете маркер цели в конце вашей фазы командования и юнит носителя (или любой Heavy Transport, в который он погружен) в дистанции до того маркера цели, тот маркер цели остаётся под вашим контролем, пока уровень контроля вашего оппонента над тем маркером цели не станет больше вашего в конце фазы.`,
        },
        {
...
Юниты Adeptus Astartes Vehicle вашей армии (исключая Fortifications, Drop Pods, Walkers и юниты, которые могут Fly) имеют ключевое слово Tank Ace. На шаге Muster Armies вы можете выбрать до трёх юнитов Tank Ace вашей армии, чтобы они получили ключевое слово Character.`,
      ...
      stratagems: [
        armourOfContempt,
        {
          ...
          effect: 'До конца фазы каждый раз, когда модель вашего юнита совершает атаку дальнего боя по юниту Monster или Vehicle, улучшите характеристику бронепробития (AP) той атаки на 1.',
        ...
        },
        {
          ...
          when: 'Ваша фаза стрельбы.',
          target: 'Один юнит Tank Ace вашей армии, который ещё не был выбран для стрельбы в этой фазе.',
          effect: 'До конца фазы каждый раз, когда модель вашего юнита совершает атаку по юниту Monster или Vehicle, перебросьте бросок на ранение 1. Если целевой юнит ниже своей стартовой численности, вы можете перебросить бросок на ранение целиком.',
      ...
      enhancements: [
        ...
        },
        {
          ...
          body: `Только модель Adeptus Astartes Vehicle. Один раз за фазу вы можете перебросить один бросок на попадание, один бросок на ранение и один бросок урона для носителя.`,
        },
        {
          ...
          body: `Только модель Adeptus Astartes Vehicle. Носитель имеет неуязвимый спас-бросок 5+ и в конце вашей фазы командования восстанавливает 1 потерянную рану.`,
        },
      ],
    },
