...
export default {
  armyRule: {
    body: `При формировании вашей армии, если фракция вашей армии — TITANICUS TRAITORIS, пропустите шаг «Выбор правил детачмента». На шаге «Выбор Warlord» выберите одну модель TITANICUS TRAITORIS из вашей армии своим WARLORD, даже если та модель не имеет ключевого слова CHARACTER. Ваша армия имеет Force Disposition Take and Hold.
