  ...
  en: {
    ...
    footer: {
      ...
      support: {
        ...
        intro: 'This app is free, has no ads, asks for no account and sells nothing. It is written and kept up to date by one person in their own time; the running costs — the domain, the CDN and the storage behind it — are paid the same way.',
        ...
        how: 'The button opens the payment page of the author\u2019s bank — from any Russian bank, without a fee. On a computer, scan the code with your phone instead.',
  ...
  ru: {
    ...
    footer: {
      ...
      support: {
        ...
        intro: 'Приложение бесплатное, без рекламы, без обязательного аккаунта и без платных функций. Его пишет и поддерживает в актуальном состоянии один человек в своё свободное время; расходы — домен, CDN и хранилище — оттуда же.',
        ...
        how: 'Кнопка открывает страницу оплаты в банке автора — из любого российского банка, без комиссии. С компьютера удобнее отсканировать код телефоном.',
