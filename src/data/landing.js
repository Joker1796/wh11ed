  ...
  en: {
    ...
    footer: {
      ...
      support: {
        ...
        intro: 'This app is free, has no ads, asks for no account and sells nothing. It is written and kept up to date by one person in their own time. The domain, the CDN and the storage behind it come out of the same pocket.',
        what: 'A donation changes nothing about the app: there is no paid tier, no perks, nothing gets unlocked. It simply keeps this going, and it says the work is worth something. Any amount is welcome, once or never again.',
        how: 'The button opens the payment page of the author\u2019s bank. It works from any Russian bank, without a fee. On a computer, scan the code with your phone instead.',
        button: 'Support via SBP',
        qrAlt: 'QR code of the donation link',
        thanks: 'Thank you, genuinely. And thank you just as much for the bug reports and the corrections: those cost you time, and they make the app better than money does.',
      },
  ...
  ru: {
    ...
    footer: {
      ...
      support: {
        ...
        intro: 'Приложение бесплатное, без рекламы, без обязательного аккаунта и без платных функций. Его пишет и поддерживает в актуальном состоянии один человек в своё свободное время. Домен, CDN и хранилище он оплачивает сам.',
        what: 'Донат ничего не меняет в приложении: платной версии нет, привилегий нет, ничего не открывается. Он просто помогает всему этому продолжаться и говорит, что работа чего-то стоит. Любая сумма, один раз или никогда.',
        how: 'Кнопка открывает страницу оплаты в банке автора: заплатить можно из любого российского банка, без комиссии. С компьютера удобнее отсканировать код телефоном.',
        button: 'Поддержать через СБП',
        qrAlt: 'QR-код ссылки для доната',
        thanks: 'Спасибо, правда. И ровно так же спасибо за сообщения об ошибках и уточнения по правилам: это ваше время, и приложение от них становится лучше, чем от денег.',
      },
