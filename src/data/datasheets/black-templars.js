// Black Templars — datasheets. Generated by scripts/import-wahapedia-datasheets.mjs from
// the Wahapedia CSV exports (unit roster and points from src/data/mfm/black-templars.js).
...
export default [
  ...
  },
  {
    ...
    "leader": {
      ...
      "footer": "You can attach this model to one of the units on the left even if one Captain or Chapter Master model has already been attached to it. If you do, and that Bodyguard unit is destroyed, the Leader units attached to it become separate units, with their original Starting Strengths."
    },
    "keywords": [
      "Grenades",
      "Character",
  ...
  },
  {
    ...
    "abilities": [
      ...
      {
        "name": "Temple Relics",
        "text": "In your Command phase, if this unit contains one or more Cenobyte Servitor models, select one Temple Relics ability (see left). Until the start of your next Command phase, this unit’s Chaplain Grimaldus model has that ability."
      }
    ],
    "specialAbilities": [
      {
  ...
  },
  {
    ...
    "leader": {
      ...
      "footer": "You can attach this model to one of the above units even if one Captain, Chapter Master, Execrator or Lieutenant model has already been attached to it. If you do, and that Bodyguard unit is destroyed, the Leader units attached to it become separate units, with their original Starting Strengths."
    },
    "keywords": [
      "Infantry",
      "Character",
