  ...
  'brotherhood-techmarine': {
    ...
    abilities: {
      ...
      'Guardians of the Machine':
        'Каждый раз, когда вражеский юнит завершает манёвр нападения в дистанции ввязывания одного или более юнитов Grey Knights Vehicle из вашей армии и в пределах 6" от юнита этой модели, вы можете нацелить стратагему Heroic Intervention на юнит этой модели за 0 CP, и можете сделать это, даже если вы уже нацелили эту стратагему на другой юнит в этой фазе.',
    },
  ...
  'grand-master-voldus': {
    ...
    abilities: {
      ...
      'Hammer Aflame (Psychic)':
        'Каждый раз, когда юнит этой модели выбирается для схватки, вы можете выбрать один вражеский юнит в дистанции ввязывания юнита этой модели и бросить один D6: на 2–3 этот вражеский юнит получает 1 смертельную рану; на 4–5 — D3 смертельные раны; на 6 — D3+3 смертельные раны.',
    },
  ...
  'interceptor-squad': {
    ...
    abilities: {
      'Personal Teleporters':
        'В вашей фазе стрельбы, после того как этот юнит отстрелялся, если он не находится в дистанции ввязывания одного или более вражеских юнитов, он может совершить обычный манёвр до 6". Если он это делает, до конца хода этот юнит не может объявить нападение.',
    },
    loadout: `${EQUIP_EVERY} storm bolter; Nemesis force weapon.`,
    options: [
