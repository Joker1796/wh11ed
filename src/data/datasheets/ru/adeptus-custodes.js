...
export default {
  ...
  'shield-captain': {
    ...
    abilities: {
      'Master of the Stances':
        'Один раз за битву, когда юнит этой модели выбирается для схватки, он может задействовать эту способность. Если он это делает, до разрешения этой схватки для этого юнита активны оба Ka’tah Stances, а не только один.',
      'Strategic Mastery':
  ...
  'venerable-contemptor-dreadnought': {
    ...
    abilities: {
      'Unyielding Ancient':
        'Когда эта модель уничтожается впервые, уберите её из игры, не разрешая её способность Deadly Demise. Затем, в конце фазы, бросьте один D6: на 2+ снова поставьте эту модель на поле боя как можно ближе к месту, где она была уничтожена, и не в дистанции ввязывания каких-либо вражеских юнитов, с D6 оставшимися ранами.',
    },
