...
export default {
  ...
  'ares-gunship': {
    ...
    abilities: {
      'Infernus Firebombs':
        'В конце вашей фазы движения выберите один видимый вражеский юнит (исключая юниты AIRCRAFT и юниты с Lone Operative) в пределах 24" от этого юнита:\n▪ Этот вражеский юнит не может иметь Benefit of Cover до конца вашей следующей фазы стрельбы.\n▪ Бросьте один D6 за каждую модель этого вражеского юнита: за каждый 6 этот вражеский юнит получает 1 смертельную рану.',
    },
  ...
  'custodian-wardens': {
    ...
    abilities: {
      'Resolute Will':
        'Пока модель CHARACTER возглавляет этот юнит, каждый раз, когда атака нацеливается на этот юнит, если характеристика Силы (Strength) этой атаки больше характеристики Стойкости (Toughness) этого юнита, вычтите 1 из броска ранения.',
      'Living Fortress':
  ...
  'shield-captain': {
    ...
    abilities: {
      ...
      'Strategic Mastery':
        'Один раз за раунд боя один юнит из вашей армии с этой способностью может задействовать её, когда он выбирается целью стратагемы. Если он это делает, уменьшите стоимость CP этого применения этой стратагемы на 1 CP.',
    },
    wargear: {
      'Praesidium shield': PRAESIDIUM_SHIELD,
    },
