  ...
  'questoris-knight-styrix': {
    ...
    abilities: {
      'Styrix’s Duty (Bondsman)':
        'Пока на модель действует эта способность, каждый раз, когда эта модель выбирается для стрельбы или ближнего боя, после того как она отыграет все свои атаки, выберите один вражеский юнит, поражённый одной или более из этих атак; этот юнит должен пройти проверку на боевой шок, вычитая 1 из проверки.',
