...
export default {
  ...
  daemonifuge: {
    ...
    abilities: {
      ...
      'Mysterious Saviours':
        'Вы можете нацелить стратагему Heroic Intervention на этот юнит за 0 CP, и можете сделать это, даже если вы уже нацелили эту стратагему на другой юнит в этой фазе.',
    },
    loadout:
  ...
  'ministorum-priest': {
    flavor:
      'Роль Ministorum Priest — обуздывать веру имперских воинов в бою. Часто они присоединяются к Войнам Веры — хотя не редкость, когда Проповедник ведёт такую войну сам. Они полны грозного религиозного пыла, что подстрекает верных, пока они рычат катехизисы ненависти.',
    abilities: {
      'Righteous Smiting':
  ...
  'retributor-squad': {
    ...
    abilities: {
      ...
      'Storm of Retribution':
        'Каждый раз, когда модель этого юнита совершает дальнобойную атаку, перебросьте бросок попадания, равный 1, и бросок ранения, равный 1. Если такая атака нацелена на вражеский юнит, что уничтожил один или более юнитов Adepta Sororitas из вашей армии за битву, также прибавьте 1 к броску попадания и 1 к броску ранения.',
    },
    loadout:
