...
export default {
  ...
  'ravenwing-command-squad': {
    ...
    abilities: {
      ...
      'Honour or Death':
        'Пока этот юнит содержит Ravenwing Champion, прибавьте 1 к броскам продвижения и нападения для этого юнита, и вы можете нацелить стратагему Heroic Intervention на этот юнит за 0 CP.',
    },
    loadout:
