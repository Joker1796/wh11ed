// Titan Legions — русский перевод листов данных. Разреженный оверлей поверх EN (см.
// ./index.js): переведены только тексты (flavor, тексты способностей, loadout, options,
// damaged). Имена юнитов/оружия, характеристики, keywords (Imperium, Titanic, Towering,
// Vehicle, Walker, Frame), [BRACKET]-теги ([BLAST], [SUSTAINED HITS 1], [MELTA 4],
// [INDIRECT FIRE], [ANTI-FLY 4+], [HAZARDOUS], [IGNORES COVER], [TORRENT], [HEAVY]),
// core/faction-правила (Deadly Demise, Super-heavy Walker — уже описаны в разделе базовых
// способностей) остаются английскими и наследуются от EN. `abilityNamesRu` (внизу) даёт
// RU-подписи для названий способностей.
  ...
  'warbringer-nemesis-titan': {
    ...
    abilities: {
      ...
      'Titanic Fire Support':
        'В вашей фазе стрельбы, после того как эта модель выстрелила, выберите один вражеский юнит, поражённый одной или более из этих атак. До конца фазы каждый раз, когда дружественная модель IMPERIUM совершает атаку, нацеленную на этот вражеский юнит, при критическом ранении улучшайте характеристику Бронепробития (AP) этой атаки на 1.',
    },
    damaged: {
