...
export const abilityNamesRu = {
  ...
  'Priority Target Acquisition': 'Приоритетная цель',
  ...
  'Trifold Path of Shadow': 'Тройной путь тени',
  'Shield Dome': 'Купол-щит',
  'Targeted Intercession': 'Целевой перехват',
  ...
  'Purgation Run': 'Карательный рейд',
