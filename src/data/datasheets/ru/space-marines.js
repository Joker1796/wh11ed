...
export default {
  ...
  'chief-librarian-tigurius': {
    ...
    abilities: {
      ...
      'Master of Prescience (Psychic)':
        'Пока эта модель возглавляет юнит, каждый раз, когда атака нацеливается на этот юнит, вычтите 1 из броска попадания. Кроме того, один раз за раунд боя вы можете нацелить на этот юнит одну из следующих стратагем за 0 CP: Counter-offensive; Fire Overwatch; Go to Ground; Heroic Intervention.',
    },
  ...
  'lieutenant-with-combi-weapon': {
    ...
    abilities: {
      ...
      'Evade and Survive':
        'Один раз за ход, когда вражеский юнит завершает обычный манёвр, продвижение или отступление в пределах 9" от этого юнита, если этот юнит не находится в дистанции ввязывания одного или более вражеских юнитов, он может совершить обычный манёвр.',
    },
  ...
  'terminator-squad': {
    ...
    abilities: {
      'Teleport Homer':
        'В начале битвы вы можете поставить один жетон Teleport Homer для этого юнита где угодно на поле боя вне зоны развёртывания вашего оппонента. Если вы это делаете, один раз за битву вы можете нацелить на этот юнит стратагему Rapid Ingress за 0 CP, но при разрешении этой стратагемы вы обязаны развернуть этот юнит в пределах 3" от этого жетона и не в пределах 9" от любых вражеских моделей. Затем этот жетон убирается.',
      'Fury of the First':
  ...
  'uriel-ventris': {
    ...
    abilities: {
      'Unorthodox Strategist (Aura)':
        'Каждый раз, когда ваш оппонент нацеливает стратагему на юнит из своей армии, если этот юнит находится в пределах 12" от этой модели, увеличьте стоимость этого применения этой стратагемы на 1 CP (это не складывается с любыми другими правилами, что увеличили бы стоимость этой стратагемы в CP).',
      'Master of the Fleet':
...
export const abilityNamesRu = {
  ...
  'Unorthodox Strategist (Aura)': 'Неортодоксальный стратег (Аура)',
