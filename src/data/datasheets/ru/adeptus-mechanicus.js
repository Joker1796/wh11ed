...
export default {
  ...
  'serberys-raiders': {
    ...
    abilities: {
      'Tactica Obliqua':
        'Один раз за ход, когда вражеский юнит завершает обычный манёвр, продвижение или отступление в пределах 9" от этого юнита, если этот юнит не находится в дистанции ввязывания одного или более вражеских юнитов, он может сделать одно из следующего:\n▪ Совершить обычный манёвр до D6".\n▪ Совершить обычный манёвр до 6", при условии, что каждая модель этого юнита завершает манёвр целиком в пределах 6" от одного или более дружественных юнитов Adeptus Mechanicus Battleline.',
    },
    wargear: {
