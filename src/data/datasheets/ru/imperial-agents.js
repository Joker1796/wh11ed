...
export default {
  ...
  'ministorum-priest': {
    ...
    leader: {
      text: LEADER_TEXT,
      footer:
        'Эту модель можно присоединить к юниту INQUISITORIAL AGENTS, даже если к нему уже присоединён один INQUISITOR. Если вы так делаете и этот юнит телохранителей уничтожается, юниты-лидеры, присоединённые к нему, становятся отдельными юнитами со своей исходной начальной численностью.',
    },
  },
  ...
  'vindicare-assassin': {
    ...
    abilities: {
      Deadshot:
        'Каждый раз, когда эта модель совершает дальнобойную атаку, при выборе целей этой атаки вы можете игнорировать способность Lone Operative.',
      Shieldbreaker:
...
export const abilityNamesRu = {
  ...
  'Lord of Deceit (Aura)': 'Владыка обмана (Аура)',
