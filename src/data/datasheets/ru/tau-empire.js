...
export default {
  ...
  'sky-ray-gunship': {
    ...
    abilities: {
      ...
      'Targeting Array':
        'Каждый раз, когда этот юнит выбирается для стрельбы, при отыгрыше этих атак вы можете перебросить один бросок попадания или один бросок ранения.',
    },
    damaged: { note: 'осталось 1–5 ран', text: dmgHit('1–5') },
    options: [
      '2 twin pulse carbines этой модели можно заменить на одно из следующего:\n▪ 2 accelerator burst cannons\n▪ 2 smart missile systems',
  ...
  'tidewall-droneport': {
    ...
    abilities: {
      Droneport:
        'Каждый раз, когда этот Fortification выбирается для стрельбы, оружие его drone defender будет целиться и отыгрывать атаки против каждого вражеского юнита, что является допустимой целью для этого Fortification.',
