...
▪ **Одна партия — несколько телефонов.** Значок с людьми рядом с кнопками партии делает её общей: остальные подключаются по ссылке, QR или шестизначному коду — «Подключиться к общей партии» на странице трекера, — выбирают, кто они, и каждый ведёт свою сторону, а табло у всех одно с задержкой в несколько секунд. Аккаунт нужен только хосту. Карточка чужой стороны у вас на экране, но приглушена: вы её видите — лист, текст правила армии, — а ведут её они; это касается и хоста, пока он не освободит их место в окне партии. Шестерёнка на подключившемся телефоне настраивает только то, что показывает этот телефон, — например, карточку правила армии соперника. Пропала связь — ничего не меняется: играйте дальше, телефоны догонят друг друга; точка на полосе раундов показывает, как дела у синхронизации. Когда партия закончится, каждый сохраняет её в свою историю.`,
      },
      {
        id: 'help-broadcast',
