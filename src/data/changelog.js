...
export const changelog = [
  {
    ...
    en: [
      ...
      { h: 'Roster import: 1,800 tournament lists later' },
      'Lists pasted from listhammer and the GW app import with the right weapons on the right models where they used to pool them: a Seraphim Superior\u2019s pistol and power weapon, a Death Company squad\u2019s three power fists, a Stormsword\u2019s sponsons, a Purgation Squad\u2019s incinerators. Older WTC exports with section headings and pastes that lost their parentheses import too. An Upgrade enhancement taken by several units now counts once toward the enhancement limit, as the rules say.',
    ...
    ru: [
      ...
      'Каталог и ваш список прокручиваются каждый сам по себе, страница под ними больше не едет \u2014 никаких упоров в конец одного списка с последующим рывком всего экрана. Строка над ними стала ниже, высота досталась панелям. Панель с очками не переносится на двух строк ни на одном телефоне.',
      ...
      { h: 'Импорт ростеров: после 1800 турнирных списков' },
      'Списки из listhammer и приложения GW импортируются с правильным оружием у правильных моделей там, где раньше оно сваливалось в одну кучу: пистолет и силовое оружие у Seraphim Superior, три силовых кулака у Death Company, спонсоны Stormsword, инсинераторы Purgation Squad. Старые экспорты WTC с заголовками разделов и вставки без скобок тоже читаются. Улучшение-Upgrade у нескольких юнитов считается в лимит улучшений один раз, как по правилам.',
