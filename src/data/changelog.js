...
export const changelog = [
  {
    ...
    en: [
      ...
      'The weapon tables sit flush with the statline and each other (a page-wide table margin had been adding 16px around each). On a phone the five header buttons fold into one \u201c\u2026\u201d, and an empty Abilities heading no longer prints.',
    ...
    ru: [
      ...
      'Таблицы оружия прижаты к статлайну и друг к другу (общий отступ таблиц страницы добавлял по 16px вокруг каждой). На телефоне пять кнопок шапки сворачиваются в одну \u00ab\u2026\u00bb, пустой заголовок «Способности» больше не печатается.',
