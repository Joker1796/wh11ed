...
export const changelog = [
  {
    ...
    en: [
      ...
      'Genestealer Cults’ card gets two more one-taps: a “+2 Deeds That Speak to the Masses” button for round 1, and a log of every unit brought back via Cult Ambush — each entry undoable, and shown in the results recap too.',
      { h: 'Game history' },
    ...
    ru: [
      ...
      'У карточки Genestealer Cults появились ещё два быстрых действия: кнопка «+2 Deeds That Speak to the Masses» на 1-й раунд и список всех юнитов, воскрешённых через Cult Ambush, — каждую запись можно отменить, и она же попадает в итоговый рекап.',
      { h: 'История партий' },
