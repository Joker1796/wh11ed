...
export const changelog = [
  {
    ...
    ru: [
      ...
      { h: 'Тёмная тема: ошибки и перебор очков видны' },
      'Перебор очков, ошибки списка и кнопки удаления в тёмной теме были тёмно-бордовыми и терялись на фоне. Теперь они того же красного, что и остальные предупреждения.',
