...
export const changelog = [
  {
    ...
    en: [
      ...
      { h: 'Datasheet page: tighter, and one \u201c\u2026\u201d on a phone' },
      'The weapon tables sit flush with the statline and each other (a page-wide table margin had been adding 16px around each). On a phone the five header buttons fold into one \u201c\u2026\u201d, an empty Abilities heading no longer prints, and the space after an ability\u2019s name is back.',
    ...
    ru: [
      ...
      { h: 'Страница датащита: плотнее, и одна \u00ab\u2026\u00bb на телефоне' },
      'Таблицы оружия прижаты к статлайну и друг к другу (общий отступ таблиц страницы добавлял по 16px вокруг каждой). На телефоне пять кнопок шапки сворачиваются в одну \u00ab\u2026\u00bb, пустой заголовок «Способности» больше не печатается, а после названия способности снова стоит пробел.',
      { h: 'Трекер партии: напоминание по фазам' },
      '\u00ab\u041aак если бы это была ваша фаза движения\u00bb больше не читается как срок: Personal Teleporters (Grey Knights) и ещё 25 способностей показываются только в той фазе, где действительно срабатывают.',
    ],
  },
  {
    version: '2.6.0',
