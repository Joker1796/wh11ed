...
export const changelog = [
  {
    ...
    ru: [
      ...
      'Прогнали 1817 турнирных списков с listhammer через импорт \u2014 все они теперь читаются: оружие попадает к нужным моделям, старые экспорты WTC с заголовками разделов и вставки без скобок тоже импортируются. Upgrade-улучшение у нескольких юнитов считается в лимит улучшений один раз.',
