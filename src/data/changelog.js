...
export const changelog = [
  {
    ...
    en: [
      ...
      'Fixed the Game Tracker\'s army-rule counter showing the wrong starting value for Genestealer Cults and Aeldari in a Combat Patrol game.',
      'Combat Patrol faction pages: unit names were missing from their datasheet cards — added; pages now use the faction\'s own accent colour like the normal faction pages; detachment rule, army rule, stratagem and enhancement names now show a Russian translation underneath.',
      { h: 'Event Companion' },
    ...
    ru: [
      ...
      'Исправлен счётчик армейского правила в Трекере партии — показывал неверное стартовое значение для Genestealer Cults и Aeldari в игре Combat Patrol.',
      'Страницы фракций Combat Patrol: на карточках юнитов не отображались названия — добавлено; страницы теперь окрашены в цвет фракции, как обычные страницы фракций; названия правила детачмента, армейского правила, стратагем и улучшений теперь показывают русский перевод под собой.',
