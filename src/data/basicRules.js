...
▪ Юнит не может начинать действие (action), а любое начатое действие не может быть завершено.`,
    ...
    {
      title: 'Даташиты',
      description: 'У каждого юнита есть даташит (datasheet), объясняющий, как он функционирует в бою. Здесь вы узнаете, как использовать даташиты при подготовке армии и в игре.',
      subsections: [
        {
          title: 'Название даташита',
...
▪ Invulnerable Save (InSv): результат броска (например, 4+). Некоторые модели защищены дополнительно — силовыми полями или сверхъестественными рефлексами. Не у всех есть InSv, но если есть — указывается здесь.
...
▪ Damage (D): количество урона, наносимого атакой.`,
        ...
        {
          title: 'Keywords',
          body: `Даташиты содержат список Keywords, разделённых на Keywords фракции и прочие Keywords. Первые используются при формировании армии, но в остальном оба типа функционируют одинаково. Keywords пишутся заглавными буквами жирным шрифтом.
...
Некоторые правила связаны с одним или несколькими Keywords. Например, правило может гласить, что оно применяется к юнитам INFANTRY — значит, только к тем, кто имеет Keyword INFANTRY. Единственное и множественное число одного Keywords работают одинаково.`,
        ...
        },
        {
          ...
          body: `На некоторых даташитах есть список опций варгира. Включая такой юнит в армию, вы можете использовать эти опции, чтобы изменить оружие и другой варгир его моделей.`,
        },
      ],
    },
    {
...
▪ Одна группа для всех остальных моделей с одинаковыми W, Sv и InSv.
