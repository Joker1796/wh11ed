...
const en = {
  ...
  terrain: {
    ...
    legend: [
      { id: 'dense', label: 'Dense Terrain', desc: 'Coloured green on the layouts.', icon: '/images/event/legend-dense.jpg' },
      { id: 'light', label: 'Light Terrain', desc: 'Coloured yellow on the layouts.', icon: '/images/event/legend-light.jpg' },
      { id: 'separate', label: 'Separate Terrain Areas', desc: 'Marked on layouts where neighbouring terrain features are treated as separate terrain areas.', icon: '/images/event/legend-separate.jpg' },
      { id: 'single', label: 'Single Terrain Area', desc: 'Marked on layouts where neighbouring terrain features are treated as one single terrain area.', icon: '/images/event/legend-single.jpg' },
      { id: 'letters', label: 'Terrain Feature Letters', desc: 'The letters marking each terrain feature correspond with the component markings on the Battlefields: Armageddon terrain set.', icon: '/images/event/legend-letters.jpg' },
      { id: 'atk-dz', label: "Attacker's Deployment Zone", desc: 'The Attacker sets up their units wholly within this area.', icon: '/images/event/legend-atk-dz.jpg' },
      { id: 'def-dz', label: "Defender's Deployment Zone", desc: 'The Defender sets up their units wholly within this area.', icon: '/images/event/legend-def-dz.jpg' },
      { id: 'nml', label: "No Man's Land", desc: "The region not within either player's deployment zone.", icon: '/images/event/legend-nml.jpg' },
      { id: 'atk-territory', label: "Attacker's Territory", desc: "The half of the battlefield that includes the Attacker's deployment zone.", icon: '/images/event/legend-atk-territory.jpg' },
      { id: 'def-territory', label: "Defender's Territory", desc: "The half of the battlefield that includes the Defender's deployment zone.", icon: '/images/event/legend-def-territory.jpg' },
