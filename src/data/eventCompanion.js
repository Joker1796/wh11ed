...
const ru = {
  sequence: {
    introduction: {
      ...
      body:
        ...
        'В этом компаньоне вы найдёте готовый каркас для выравнивания условий игры и ' +
        ...
        '▪ **Terrain Layouts:** набор тщательно продуманных расстановок укрытий (terrain) ' +
      ...
      note:
        "**Designer's Note:** этот компаньон использует не всё содержимое Chapter Approved " +
        ...
        'pick-up-and-play.\n\n' +
        'Этот компаньон не включает правила и рекомендации для парных, командных или ' +
        'Dominatus-мероприятий Warhammer Events. Их можно найти на warhammer-community.com.',
      seeAlso: ['Последовательность миссии EC:sequence', 'Расстановки укрытий EC:layouts'],
    },
    intro:
    ...
    blocks: [
      {
        ...
        seeAlso: ['Расстановки укрытий EC:layouts'],
      },
      {
  ...
  glossary: [
    ...
    { fullText: 'Одна из трёх рекомендованных расстановок укрытий (A, B и C) для конкретного матчапа основных миссий, задающая участки укрытий, элементы и позиции целей.' },
  ],
