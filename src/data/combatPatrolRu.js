...
**Каждый Intercessor вооружён:** Bolt Pistol; Bolt Rifle; Knives and Fists.`,
        },
        {
          ...
          abilities: [
            ...
            {
              name: 'Master of War',
              text: 'В конце фазы атаки противника, если этот юнит не находится в рукопашной и находится в пределах 6" от одного или более вражеских юнитов, вы можете использовать эту способность. Если делаете это, разыграйте этим юнитом рывок в атаку. При броске на рывок, если результат больше 6 (с учётом модификаторов), измените его на 6.',
            },
          ],
...
Атаки ближнего боя этого юнита, нацеленные на юнит Psyker, имеют [PRECISION].
▪ Когда этот юнит объявляет нападение, если вражеский юнит Psyker находится в пределах 12" от этого юнита, вы можете задействовать эту часть этой способности. Если вы это делаете:
▪ Этот юнит может перебросить этот бросок нападения.
▪ Этот юнит обязан завершить этот манёвр нападения в дистанции ввязывания одного или более из этих вражеских юнитов Psyker.
...
Если у этого юнита есть ключевое слово Infantry:
▪ В конце вашей фазы командования, если этот юнит находится в пределах досягаемости контролируемого вами маркера цели, этот маркер остаётся под вашим контролем до тех пор, пока уровень контроля вашего оппонента над ним не окажется выше вашего в конце фазы.
▪ Если в разыгрываемой миссии есть Actions, этот юнит может начинать выполнение Action в том ходу, в котором он продвигался.
