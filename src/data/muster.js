...
Они сведены ниже.`,
        },
        {
          ...
          body: `Теперь вы выберете **[gloss:detachments:детачменты]**, юниты, ВОЕНАЧАЛЬНИКА (WARLORD) и **[gloss:enhancement:улучшения]**, которые будут в вашей армии. Вы также присоедините свои отряды **[gloss:leader:лидера]** и **[gloss:support:поддержки]** к другим отрядам.
