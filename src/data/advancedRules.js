...
Когда отряд **телохранителей** (bodyguard) в **объединённом** отряде, на который влияет такое правило, **уничтожен**, все эти отряды **лидера/поддержки** остаются единым отрядом для всех игровых целей.`,
        ...
        },
        {
          ...
          body: `Каждый раз, когда атака нацелена на **объединённый** (attached) отряд, если он содержит одну или несколько моделей **телохранителей** (bodyguard), используйте наивысшую характеристику **T** моделей **телохранителей** в этом отряде при отыгрыше этой атаки, даже если отряд **лидера/поддержки** (leader/support) в этом **объединённом** отряде имеет другую характеристику **T**. Если отряд содержит только модели **лидера/поддержки**, вместо этого используйте наивысшую характеристику **T** этих моделей.
...
Если отряд имеет предмет снаряжения со **способностью снаряжения**, эта способность применяется к отряду. Если модель в составе отряда имеет предмет снаряжения со **способностью снаряжения**, эта модель является «носителем» этого предмета снаряжения, и способность действует до тех пор, пока эта модель не будет **уничтожена** (destroyed).`,
        },
        {
          ...
          body: `Каждый раз, когда модель совершает дальнюю атаку, нацеленную на **видимый** (visible) отряд, содержащий одну или несколько моделей на **уровне земли** (ground level), если применяется одно или несколько следующих условий, улучшите характеристику **BS** этой атаки на 1:
...
▪ Нахождение **в ближнем бою** (engaged) исключительно с одним или несколькими отрядами ВОЗДУШНЫХ СУДОВ не препятствует праву отряда совершать **обычный манёвр** (normal move) или **продвижение** (advance move).`,
        },
        {
          ...
          sectionNum: '23.03',
          title: 'Стрельба',
          body: `Правило «Стрельба с возвышения» (Plunging Fire) (22.05) не влияет на атаки, совершаемые отрядами ВОЗДУШНЫХ СУДОВ (AIRCRAFT) или нацеленные на них.`,
        },
        {
          id: 'section-23-04',
          sectionNum: '23.04',
