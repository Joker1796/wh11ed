...
До битвы, на шаге «Объявление боевых построений» (Declare Battle Formations step), ваши отряды могут начать погружёнными в любую дружественную модель ТРАНСПОРТ с достаточной оставшейся **вместимостью транспорта** для всего отряда.`,
        },
        {
          ...
          sectionNum: '18.02',
          title: 'Погрузка',
          body: `После начала первого раунда боя (battle round) дружественный отряд может погрузиться в дружественную модель ТРАНСПОРТ (TRANSPORT) после совершения **обычного движения** (normal move), **ускоренного движения** (advance move) или **отступления** (fall-back move), если применяются **все** следующие условия:
...
▪ Когда они убираются с поля боя, любые правила, действующие на такие отряды в течение определённого срока или при определённых обстоятельствах, продолжают действовать на них, пока этот срок и/или обстоятельства применяются.`,
        ...
        },
        {
          ...
          body: `Для прибытия на поле боя каждый отряд **стратегического резерва** (strategic reserves) должен совершить **движение прибытия** (ingress move) (см. ниже). Если не указано иное, они могут сделать это только начиная со второго раунда боя (battle round).
