...
Когда отряд **телохранителей** (bodyguard) в **объединённом** отряде, на который влияет такое правило, **уничтожен**, все эти отряды **лидера/поддержки** остаются единым отрядом для всех игровых целей.`,
        ...
        },
        {
          ...
          body: `Каждый раз, когда атака нацелена на **объединённый** (attached) отряд, если он содержит одну или несколько моделей **телохранителей** (bodyguard), используйте наивысшую характеристику **T** моделей **телохранителей** в этом отряде при разрешении этой атаки, даже если отряд **лидера/поддержки** (leader/support) в этом **объединённом** отряде имеет другую характеристику **T**. Если отряд содержит только модели **лидера/поддержки**, вместо этого используйте наивысшую характеристику **T** этих моделей.
