...
[img:/images/fight/overrun-fight-ru.jpg|Бой с преследованием — условия доступности]`,
      ...
      },
      {
        ...
        body: `Оба игрока совершают **консолидации (consolidation moves)** (см. ниже) со своими имеющими право юнитами, которые они решают переместить. Игрок, чей сейчас ход, выполняет все свои перемещения первым, затем его оппонент. Каждый юнит не может совершить более одной **консолидации (consolidation move)** во время этого шага.`,
      },
      {
        title: 'Консолидация',
        body: `◈ МАКСИМАЛЬНОЕ РАССТОЯНИЕ | 3"
...
◈ ЭФФЕКТ | Ваш юнит перемещается, как описано в разделе «Перемещение» (03).
◈ ПЕРЕД ПЕРЕМЕЩЕНИЕМ | Выберите режим консолидации (consolidation mode):
...
◈ ВО ВРЕМЯ ПЕРЕМЕЩЕНИЯ
▪ **Продолжающаяся консолидация:** Модели в базовом контакте с одной или несколькими вражескими моделями не могут быть перемещены. Каждая перемещаемая модель должна завершить своё перемещение ближе к ближайшему выбранному вражескому юниту и **связанной боем (engaged)** с ним, если возможно.
▪ **Боевая консолидация:** Каждая перемещаемая модель должна завершить своё перемещение ближе к ближайшему выбранному вражескому юниту и **связанной боем (engaged)** с ним, если возможно.
▪ **Консолидация на цели:** Каждая перемещаемая модель должна завершить своё перемещение в пределах досягаемости выбранной цели (objective), если возможно, или ближе к ней, если нет.
◈ ПОСЛЕ ПЕРЕМЕЩЕНИЯ
▪ **Продолжающаяся консолидация:** Каждая модель, которая начала это перемещение **связанной боем (engaged)** с вражеским юнитом, должна всё ещё быть **связана боем (engaged)** с этим вражеским юнитом.
