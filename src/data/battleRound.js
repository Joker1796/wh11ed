...
[img:/images/turn-structure.png|Battle round turn structure overview]`,
...
Затем игровой раунд заканчивается и, если битва не заканчивается, начинается следующий игровой раунд. Миссия, по которой вы играете, подскажет вам, сколько игровых раундов нужно отыграть до окончания битвы.`,
  ...
  // 08 — Фаза командования
  {
    ...
    description: 'В фазе командования оба игрока получают базовые СР, затем вы проверяете боевую готовность своих сил и используете любые способности стратегического уровня, которые у вас могут быть.',
    subsections: [
      {
