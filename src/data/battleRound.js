...
◈ ЭФФЕКТ | Ваш юнит перемещается, как описано в разделе «Движение» (03).
◈ ПЕРЕД МАНЁВРОМ | Выберите режим отхода:
...
▪ Он совершил **продвижение (advance)** или **отход (fall-back move)** в этом ходу.

2. Сделайте бросок на нападение (Make Charge Roll): Сделайте бросок на нападение, бросив 2D6: результат является **максимальным расстоянием** для манёвра нападением (charge move).
3. Попытка нападения (Attempt Charge): Если возможно совершить манёвр нападения (charge move) и если вы всё ещё хотите этого, совершите манёвр нападением этим юнитом. В противном случае ваш юнит не совершает манёвр нападением. В любом случае нападение затем завершается.`,
      },
      {
...
◈ ЭФФЕКТ | Ваш юнит может совершить одно дополнительное **манёвр сближения (pile-in move)**, затем сражается, как описано в разделе «Совершение атак» (04).
