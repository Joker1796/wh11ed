    ...
    subsections: [
      {
        ...
        body: `Каждый раунд боя отыгрывается путём выполнения следующих шагов:
▪ 1. Начало раунда боя
▪ 2. Ходы игроков
▪ 3. Конец раунда боя`,
      },
      {
        ...
        body: `В начале раунда боя игроки отыгрывают правила, которые срабатывают в начале раунда боя, прежде чем перейти к ходам игроков.`,
      },
      {
        title: 'Ходы игроков',
...
▪ **Ход/фаза (The Turn/the Phase):** Если правило срабатывает в __течение__ хода/фазы, а не в __вашем__ ходе/фазе или ходе/фазе __вашего оппонента__, оно срабатывает в ходе/фазе обоих игроков.`,
      ...
      },
      {
        ...
        body: `Правила, которые вступают в силу в конце раунда боя, отыгрываются в следующем порядке:
1. Сначала отыграйте правила, срабатывающие на этом этапе, за исключением правил миссии.
2. Затем оба игрока сверяются со своей миссией; если один или оба игрока выполнили какие-либо аспекты своей миссии, которые срабатывают на этом этапе, отыграйте их сейчас.
    ...
    subsections: [
      {
        ...
        body: `Фаза командования отыгрывается путём выполнения следующих шагов:
...
▪ 5. Конец фазы командования`,
      },
      {
        ...
        body: `Правила, срабатывающие в начале фазы командования, отыгрываются сейчас.`,
      },
      {
...
`,
      ...
      },
      {
        ...
        body: `Правила, срабатывающие в конце фазы командования, отыгрываются сейчас, в следующем порядке:
1. Сначала отыгрываются правила, срабатывающие в этот момент, отличные от правил миссии.
2. Затем оба игрока сверяются со своей миссией; если один или оба игрока достигли каких-либо аспектов своей миссии, которые срабатывают в этот момент, отыграйте их сейчас.`,
      },
    ],
  },
  // 09 — Фаза движения
    ...
    subsections: [
      {
        ...
        body: `Фаза движения отыгрывается путём выполнения следующих шагов:
...
▪ 3. Конец фазы движения`,
      ...
      },
      {
        ...
        body: `Правила, срабатывающие в начале фазы движения, отыгрываются сейчас.`,
      },
      {
...
Многие **[gloss:move-type:типы манёвров]** указывают условия, которые вы должны соблюсти во время/после манёвра. Те, что помечены названием режима, применяются только если вы выбрали этот режим; те, что не помечены названием режима, применяются всегда.`,
      ...
      },
      {
        ...
        body: `Правила, срабатывающие в конце фазы движения, отыгрываются сейчас.`,
      },
      {
    ...
    subsections: [
      {
        ...
        body: `Фаза стрельбы отыгрывается в соответствии со следующими шагами:
...
▪ 3. Конец фазы стрельбы`,
      },
      {
        ...
        body: `Правила, срабатывающие в начале фазы стрельбы, отыгрываются сейчас.`,
      },
      {
        title: 'Стрельба',
...
▪ **[gloss:indirect-shooting:Indirect shooting]** (Непрямая стрельба) (10.07)`,
      },
      {
        ...
        body: `Правила, срабатывающие в конце фазы стрельбы, отыгрываются сейчас.`,
      },
      {
...
▪ **Модели без МОНСТР/ТЕХНИКА:** Вы можете выбирать только орудия [CLOSE-QUARTERS] и только целями **[gloss:engaged:связанные боем]** с вашим юнитом вражеские юниты.
◈ ПОСЛЕ СТРЕЛЬБЫ | До конца фазы ваш юнит **не имеет права [gloss:eligible-to-act:начинать действие]**.`,
      },
      {
    ...
    subsections: [
      {
        ...
        body: `Фаза нападения отыгрывается в следующем порядке:
...
3. Попытка нападения (Attempt Charge): Если возможно совершить [gloss:charge-move:манёвр нападения] и если вы всё ещё хотите этого, совершите манёвр нападения этим юнитом. В противном случае ваш юнит не совершает манёвр нападения. В любом случае нападение затем отыгрывается.`,
      ...
      },
      {
        ...
        body: `Правила, срабатывающие в конце фазы нападения, отыгрываются сейчас.`,
      },
      {
    ...
    subsections: [
      {
        ...
        body: `Фаза ближнего боя отыгрывается путём выполнения следующих шагов:
...
[img:/images/fight/objective-consolidation-ru.jpg|Диаграмма консолидации к цели]`,
      ...
      },
      {
        ...
        body: `Правила, срабатывающие в конце фазы ближнего боя, отыгрываются сейчас.`,
      },
    ],
  },
 ],
