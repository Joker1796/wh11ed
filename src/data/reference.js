...
▪ Одно или несколько его других видов дистанционного оружия.`,
    },
    {
      ...
      example: 'Импульсор (Impulsor) с отрядом Интерцессоров (Intercessors) внутри него уничтожен дистанционными атаками. Сначала выполняются любые незавершённые атаки, совершённые атакующим юнитом. Затем Интерцессоры совершают **аварийный манёвр высадки** (emergency disembark move). Затем совершается бросок для способности **Смертоносная гибель** (Deadly Demise), и на 6 эта способность разрешается. Наконец, Импульсор убирается с поля боя.',
    },
    {
      // 24.09 Deep Strike
