...
Если юнит, выполняющий **действие** (action), совершает перемещение (за исключением **сближения** (pile-in) и **консолидации** (consolidation moves)) или покидает поле боя, этот юнит не завершает это **действие** (action). В противном случае, когда **действие** (action) завершается, срабатывает его раздел «Эффект».`,
