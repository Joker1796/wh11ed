...
◈ ПОСЛЕ СТРЕЛЬБЫ | До конца фазы ваш юнит не может **[gloss:action:начать действие]**.`,
      ...
      stratagems: [
        ...
        },
        {
          ...
          effect: 'До конца фазы ваш юнит получает способность **«Атакует первым»** (Fights First) и он должен быть следующим юнитом, которого вы выбираете [gloss:selected-to-fight:для совершения атак] (12.04).',
          restrictions: '',
          extraCost: [],
        },
      ],
