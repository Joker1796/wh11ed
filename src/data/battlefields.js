...
◈ ПОСЛЕ СТРЕЛЬБЫ | До конца фазы ваш юнит не может **[gloss:action:начать действие]**.`,
    ...
    },
    {
      ...
      title: 'Действия',
      page: 58,
      description: 'Действия представляют собой жизненно важные боевые задачи, которые должны выполнить ваши войска: от поиска утерянного археотеха до завершения кощунственного ритуала.',
      subsections: [
        {
          id: 'section-16-01',
          sectionNum: '16.01',
