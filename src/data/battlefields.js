...
▪ Поместите чётко определённую границу (например, база или коврик) в каждое место, которые вы хотите оборудовать укрытием, затем поместите один или несколько **элементов укрытий** полностью в пределах этой границы.
...
▪ После завершения этого перемещения эта модель устойчива, и ни одна часть её базы не свешивается за внешний край этой поверхности.
